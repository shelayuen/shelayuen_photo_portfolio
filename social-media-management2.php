			...
			<div class="gallery-container">
				<div class="fullscreen-container fs-gallery">
					<div class="row layout-masonry gallery-holder gallery-masonry3cols">
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-01.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-01.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-04.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-04.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-02.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-02.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-03.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-03.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-05.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-05.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-08.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-08.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-09.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-09.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-06.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-06.jpg" alt=""> </a></div>
						<div class="col-sm-6 col-lg-4 blog-item-masonry gallery-post"> <a href="images/albums/gal-4/gal-4-07.jpg" class="lightbox" title=""> <img class="img-fluid" src="images/albums/gal-4/gal-4-07.jpg" alt=""> </a></div>
					</div>
				</div>
				</div>	
			<!-- /gallery-container -->
				<div class="container prev-next-gallery">
					<div class="row meta-nav-holder port-meta-nav">
						<div class="col-md-6 meta-nav">
							<div class="pn-holder">
								<div class="pn-img"> <a href="#"> <img class="img-fluid" src="images/albums/featured-images/gal-3-grid.jpg" alt="Prev Gallery"> </a></div>
								<div class="pn-desc">
						...
						<div class="col-md-6 meta-nav meta-nav-right">
							<div class="pn-holder">
								...
								<div class="pn-img"> <a href="#"> <img class="img-fluid" src="images/albums/featured-images/gal-2-grid.jpg" alt="Next Gallery"> </a></div>
							</div>
						</div>
					</div>
				</div>
