	...
	<body>
		...
		<div class="overview">
			<div class="overview-inner">
				...
				<p>Mother's Day Brunch with Flower Bar Event and Social Media Contest</p>
				</div>
				<div class="overview-item">
						...
						<article class="blog-item-1col single-post-holder single-article-container">
							<div class="post-content single-post-content single-article-page clearfix">
								...
								<div class="metrics-strip">
									<div class="metric">
										<span class="metric-label">Total views (Apr 2 - May 10)</span>
								...
								<div style="padding: 1rem 0; overflow-x: auto;">
									...
									<table style="width: 100%; border-collapse: collapse; font-size: 14px; table-layout: fixed;">
										...
										<tr>
											...
											<td>42,519</td>
											<td>20,260</td>
											<td>1,517 landing page views</td>
											<td>CA$199.72</td>
										</tr>
										<tr>
