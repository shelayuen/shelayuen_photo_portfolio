...
<html lang="en-US">
	<head>
		...
		<title>Contact Me | Shela Yuen | Marketing Manager and Digital Designer for Premium Hotels</title>
		<!-- Google Fonts -->
	...
	<body class="home no-top-image">
		...
		<div class="top-single-bkg topnoimg">
			<div class="inner-desc">
				<div class="container">
					<h1 class="post-title single-post-title">Contact Me</h1>
					<span class="post-subtitle page-subtitle">Let me know how I may help</span>
				</div>
			</div>
		</div>
		<!-- /PAGE TOP -->
