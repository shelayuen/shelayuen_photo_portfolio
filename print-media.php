				...
				<div class="container prev-next-gallery">
					<div class="row meta-nav-holder port-meta-nav">
						<div class="col-md-6 meta-nav">
							<div class="pn-holder">
								<div class="pn-img"> <a href="email-marketing.php"> <img class="img-fluid" src="images/home/featured-projects/life.png" alt="Prev Gallery"> </a></div>
								<div class="pn-desc">
									<div class="meta-nav-subtitle">
										<h3><a href="email-marketing.php">← Email Marketing</a></h3>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6 meta-nav meta-nav-right">
							<div class="pn-holder">
								...
								<div class="pn-img"> <a href="3D-virtual-tour.php"> <img class="img-fluid" src="images\home\featured-projects\virtual.png" alt="Next Gallery"> </a></div>
							</div>
						</div>
					</div>
				</div>
